      ...
      <div className="glass-panel w-full max-w-md rounded-2xl p-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex gap-3">
            ...
            <div>
              <h2 id="delete-dialog-title" className="font-semibold text-zinc-100">
                Eliminar proyecto
              </h2>
              <p className="mt-2 text-sm text-zinc-400">
                ¿Eliminar <span className="text-zinc-200">{title}</span>? Esta acción no se
                puede deshacer (hard delete).
              </p>
            </div>
          </div>
          <button
